...
class RequestGenerator extends MutatorAccessorClassGeneratorAbstract
{
    ...
    protected function generateRequest(
        ...
        $classBuilder = $this->builder
            ...
            ->addStmt($this->generateBearerTokenSetter())
            ->addStmt($this->generateBearerTokenGetter())
        ;
    ...
    protected function generateProperties(Request $request, Operation $operation, Specification $specification): array
    {
        ...
        $statements[] = $this->builder->localProperty('bearerToken', 'string', 'string', true,
            $this->builder->val('')
        );
    ...
    private function generateBearerTokenSetter() : Stmt
    {
        $statements         = [];
    ...
    private function generateBearerTokenGetter() : Stmt
    {
        return $this->builder
            ->method('getBearerToken')
            ->makePublic()
            ->addStmt($this->builder->return($this->builder->localPropertyFetch('bearerToken')))
